...
| `--color-accent` | `#C25A2C` | Acento único — naranja terracota |
...
### Acento confirmado: Naranja terracota `#C25A2C`

Cálido, sofisticado, terroso. Diferencial respecto a la kinesiología tradicional que usa azules clínicos. El acento se aplica de manera contenida, nunca dominante. Aparece en bordes de nodos terminales, fondos de bloques destacados al 8% de opacidad, botones de acción primaria, y elementos de marca (logo, links activos).
...
### Familia
**Geist** como tipografía principal de Reason. Diseñada por Vercel, gratuita y open source. Disponible en Google Fonts.

URL: `https://fonts.googleapis.com/css2?family=Geist:wght@400;500&family=Geist+Mono:wght@400;500&display=swap`

Geist tiene dos variantes que vamos a usar:
- **Geist Sans**: para texto general, títulos, etiquetas, cuerpo. La fuente principal.
- **Geist Mono**: para datos clínicos numéricos. Dosis, tiempos, porcentajes, medidas. Le da rigor técnico a los datos sin sobrecargar el resto de la interfaz.

Esta dualidad refuerza el posicionamiento de Reason: criterio cálido para el razonamiento, precisión técnica para los números.
...
| Uso | Tamaño | Peso | Tracking | Familia |
|---|---|---|---|---|
| Título de visualización | 18px | 500 | -0.01em | Geist Sans |
| Etiqueta de nodo principal | 14px | 500 | 0 | Geist Sans |
| Etiqueta de nodo secundario / subtítulo | 12px | 400 | 0 | Geist Sans |
| Etiqueta de flecha / conector | 11px | 400 | 0.01em | Geist Sans |
| Pie de gráfico | 11px | 400 | 0 | Geist Sans |
| **Datos clínicos numéricos** | según contexto | 400/500 | 0 | **Geist Mono** |

Ejemplos de cuándo usar Geist Mono:
- "5x45 segundos al 70% de 1RM"
- "EVA 5/10"
- "12 semanas"
- Porcentajes, dosis, tiempos en general dentro del cuerpo del contenido
...
Sistema visual cerrado en la sesión de definición:

1. **Acento de color**: Naranja terracota `#C25A2C`
2. **Tipografía**: Geist Sans (general) + Geist Mono (datos clínicos numéricos)
3. **Filosofía**: minimalismo con jerarquía clara, no minimalismo vacío
4. **Catálogo de visualizaciones**: 6 tipos (árboles, tablas, líneas de tiempo, algoritmos, diagnósticos diferenciales, esquemas anatómicos)
