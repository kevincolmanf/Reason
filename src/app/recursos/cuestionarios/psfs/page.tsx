...
import PsfsInteractive from './PsfsInteractive'
...
export default async function PsfsPage() {
      ...
      <main className="flex-grow w-full max-w-[720px] mx-auto px-8 py-12">
        <div className="mb-8">
          ...
          <p className="text-text-secondary text-[16px] leading-[1.5]">
            Escala funcional centrada en el paciente. El paciente nombra hasta 3 actividades que no puede realizar o tiene dificultad para realizar. Sensible al cambio individual.
          </p>
        </div>
