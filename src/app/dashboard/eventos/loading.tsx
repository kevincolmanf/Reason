    ...
    <div className="min-h-screen bg-bg-secondary flex flex-col">
      ...
      <main className="flex-grow w-full max-w-[1080px] mx-auto px-8 py-12">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="h-9 w-32 bg-border rounded animate-pulse"></div>
        </div>
          ...
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="flex items-center gap-4 p-5 bg-bg-primary border-[0.5px] border-border rounded-lg">
              <div className="flex-1 space-y-2">
                <div className="h-5 w-56 bg-border rounded animate-pulse"></div>
                <div className="h-3 w-40 bg-border rounded animate-pulse"></div>
              </div>
